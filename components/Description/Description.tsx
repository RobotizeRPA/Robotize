...
// import Banner from "../../assets/rpaFriend.jpg";

export default function Description() {
  return (
    <>
      <article className="w-full h-full flex flex-row justify-center items-center text-center gap-6 w-2/3 mx-auto text-white max-sm:flex-col max-sm:w-full bg-filtro">
        <div className="w-[50%] flex flex-row justify-center items-center text-center gap-6 w-2/3 mx-auto text-white max-sm:flex-col max-sm:w-full ">
