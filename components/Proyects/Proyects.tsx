        ...
        <>
          ...
          <div className="grid grid-cols-2 items-center gap-4 max-sm:grid-cols-1">
            <div>
              ...
              <Link href='https://robotize-web.vercel.app/home' className="text-center border-2 border-robotize px-2 rounded-lg">Ver pagina</Link>
            </div>
          ...
          <div className="grid grid-cols-2 justify-items-center px-4 items-center gap-4 max-sm:grid-cols-1">
            ...
            <div>
              ...
              <Link href='https://youtu.be/BthnuG38yuU' className="text-center border-2 border-robotize px-2 rounded-lg">Ver video</Link>
            </div>
          ...
          <div className="grid grid-cols-2 items-center gap-4 max-sm:grid-cols-1">
            <div>
              ...
              <button className="text-center border-2 border-robotize px-2 rounded-lg">Ver video</button>
            </div>
            <Image src='https://res.cloudinary.com/vuelosflights/image/upload/v1697926909/arrendamiento_auitip.png' alt='RobotizeNews' width={450} height={150} className="border-2 border-robotize"/>
          </div>
        </>)
}
