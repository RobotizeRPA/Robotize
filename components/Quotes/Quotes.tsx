...
export default function Quotes(){
    return(
        <>
            ...
            <h2 className="text-3xl font-bold py-6 max-sm:text-lg">Algunos datos a tener en cuenta:</h2>
            <div className="grid grid-cols-3 py-10 gap-10 max-sm:grid-cols-1">
              <div className="flex flex-col justify-center items-center gap-4">
                ...
                <LiaHandshake className='text-100'/>
                <p className="font-bold">MANO A MANO</p>
              ...
              <div className="flex flex-col justify-center items-center gap-4">
                <BsCircle className='text-100'/>
                <p className="font-bold">ÁGIL, RÁPIDO Y TRANSPARENTE</p>
              ...
              <div className="flex flex-col justify-center items-center gap-4">
                <BsCheck2All className='text-100'/>
                <p className="font-bold">SEGURO Y FIABLE</p>
